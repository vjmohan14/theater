...
if loc=="chennai":
    language()
elif loc=="chengulpattu":
    language()
elif loc=="kanchipuram":
    language()  
#language    
...
sql="insert into movie(location,language,theater,movie_name,screen_no,timing,ticket_status,booked_tickets,cost)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
